...
data_root = '/data/doclaynet_fin_tables_corrected_pymu_dim/'
    ...
    roi_head=[
        dict(
            ...
            bbox_roi_extractor=dict(
                ...
                out_channels=256,
                roi_layer=dict(
                    output_size=7, sampling_ratio=0, type='RoIAlign'),  # Check whether change to 2
...
work_dir = './work_dirs/co_deformable_detr_5scale_r50_8xb2_1x_cocoi_my'
