...
class CoDeformDETRHead(DeformableDETRHead):
    ...
    def __init__(self,
        ...
        transformer['as_two_stage'] = as_two_stage
        ...
        super().__init__(*args, **kwargs, as_two_stage=as_two_stage)
    ...
    def forward(self,
        ...
        hs, init_reference, inter_references, topk_score, topk_anchor, enc_outputs = \
            self.transformer(
                mlvl_feats,
                mlvl_masks,
                query_embeds,
    ...
    def _loss_aux_by_feat_single(self,
        ...
        loss_cls = self.loss_cls(
            cls_scores, labels, #(labels, scores),
